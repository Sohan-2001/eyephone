...
export default function MessagesPage() {
  ...
  return (
    <main className="flex min-h-screen w-full items-center justify-center bg-black p-4 font-body">
      <div 
        ref={phoneRef}
        className="w-full max-w-[370px] h-[820px] bg-white rounded-[48px] border-[10px] border-black shadow-2xl overflow-hidden relative flex flex-col transition-all duration-300"
      >
        {/* Notch */}
