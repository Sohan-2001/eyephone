...
export default function WidgetBoard() {
  return (
    <div className="flex-1 w-full h-full overflow-y-auto overflow-x-hidden relative bg-cover bg-center" style={{backgroundImage: "url('https://placehold.co/375x812.png')"}} data-ai-hint="ios wallpaper blue green">
